...
const Hero = () => {
  return (
    ...
    >
      ...
      <div className="absolute -top-40 left-1/2 -translate-x-1/2 h-[480px] w-[480px] rounded-full bg-green-400/10 blur-[140px]" />
      ...
      <div className="relative flex flex-col items-center justify-center mx-auto w-4/5 min-h-screen pt-[12vh]">
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12 w-full">
          ...
          >
            <div className="absolute inset-0 -m-6 rounded-full border border-dashed border-green-400/30 animate-spin-slow" />
